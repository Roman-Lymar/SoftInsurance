...
import com.pasha.springboot.cassandraproject.services.ProductServiceImpl;
...
class ProductControllerTest {
    ...
    void testGetProductsByName() throws Exception {
        doReturn(Lists.newArrayList(product, product2)).when(service).getProductsByName("pro");
    ...
    void testGetProductByNameNotFound() throws Exception {
        doThrow(new ResourceNotFoundException(ErrorMessages
                .NO_RESOURCE_FOUND_BY_NAME.getErrorMessage())).when(service).getProductsByName("pro");
